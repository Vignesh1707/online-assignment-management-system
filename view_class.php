...
if(isset($_POST['Update']))
{
	...
	$Year = $_POST['Year'];
	$Class = $_POST['Class'];
	$update = $class->Class_Update($id,$Name,$Academic,$Department,$Year,$Class);
	if($update == true){
		$success_msg = "Class Details updated successfully";
		header("refresh:2;view_class.php");
	}else{
		$error_msg = "Sorry Class Details not updated ";
	}	
}
if(isset($_GET['delete_id']))
{ 
    $id = $_GET['delete_id'];
	$delete = $class->Class_delete($id);
	if($delete == true){
		$success_msg = "Class Details deleted successfully";
		header("refresh:2;view_class.php");
	}else{
		$error_msg = "Sorry,Class details not deleted";
	}	
}
?>	
          ...
          <div class="card-body">
            <div class="row">
             ...
             <div class="form-group">
                  ...
                  <select class="form-control select2" name="Academic" id="Academic" multiple="true" required>
				 ...
				 <div class="form-group">
                  ...
                  <select class="form-control select2" name="Department" multiple="true" id="Department" required>
			...
			<div class="col-sm-12">
				...
				<div class="form-group">
                  ...
                  <label>Year</label>
                  <select class="form-control select2" name="Year" multiple="true" required>
 ...
 <div class="form-group">
                  ...
                  <label>Class</label>
                  <select class="form-control select2" name="Class" multiple="true"  required>

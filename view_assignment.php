...
if(isset($_POST['submit']))
{
	    ...
	    $file_upload = $class->Files($file_upload);
	...
	if($file_upload == false){
		...
		header("refresh:2; view_assignment.php");
		}
}
?>
 ...
 <div class="wrapper">
        ...
        <div class="col-11">
          <div class="card">
            <div class="card-header">
			  <div class="pull-left">
            <h1>Student Assignment Table</h1>
			</div>
  ...
  <tr>
			...
			<td>
			<div class="btn-group">
                        <a href="#exampleModal<?php echo $i;?>" class="btn btn-default" id="button" data-toggle="modal">Submit</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div 
	  class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Work Submission Form</h5>
   ...
   <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
			 ...
			 <input type="file" name="file_upload" onchange="validatePDF(this)"  accept="application/pdf" class="form-control" value="1000" placeholder="Upload file" required multiple>
...
<center>
    ...
    <button type="submit_file" name="submit"  accept="application/pdf" value="submit" id="submit" class="btn btn-success float-center">Upload Assignment</button>
